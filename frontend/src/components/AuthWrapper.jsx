    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
        <div className="bg-white p-8 rounded-xl shadow-md text-center max-w-md">
          ...
          <p className="text-gray-600 mb-6">Sua conta foi criada com sucesso, mas precisa ser aprovada por um administrador.</p>
          <button onClick={handleSignOut} className="text-blue-600 hover:underline font-medium">Sair</button>
        </div>
      </div>
    );
  }
